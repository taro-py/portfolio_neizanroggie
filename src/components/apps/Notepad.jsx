...
- Continuous self-taught learning in information security, applying networking and systems concepts to build more robust software, as well as finding vulnerabilities in Linux systems and servers.`;
  ...
  return (
    <div className="h-full w-full flex flex-col bg-os font-mono select-text">
      ...
      <div className="h-7 px-2.5 sm:px-3 bg-window/80 border-b border-white/5 flex items-center gap-3 sm:gap-4 text-xs text-text-main/80 select-none overflow-x-auto no-scrollbar">
        <button type="button" className="hover:text-accent-cyan transition-colors shrink-0">
          File
        </button>
        <button type="button" className="hover:text-accent-cyan transition-colors shrink-0">
          Edit
      ...
      <div className="flex-1 overflow-y-auto w-full p-3.5 sm:p-8 selection:bg-accent-cyan/25 selection:text-accent-cyan">
        <div className="max-w-4xl mx-auto w-full flex flex-col">
          ...
          <div className="mt-6 sm:mt-10 mb-6 sm:mb-8 pt-4 sm:pt-6 border-t border-white/10 select-none">
            <p className="text-[10px] sm:text-[11px] text-text-main/60 mb-2 font-mono">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-2 sm:py-2.5 rounded bg-accent-cyan/10 border-2 border-accent-cyan text-accent-cyan font-mono text-xs sm:text-sm font-bold tracking-wider hover:bg-accent-cyan hover:text-black hover:shadow-[0_0_25px_rgba(0,229,255,0.6)] active:scale-95 transition-all duration-200 cursor-pointer shadow-[0_0_15px_rgba(0,229,255,0.2)]"
            >
      ...
      <div className="h-6 px-2.5 sm:px-3 bg-window/60 border-t border-white/5 flex items-center justify-between text-[10px] sm:text-[11px] text-text-main/60 select-none">
        <div className="flex items-center gap-2 sm:gap-4">
          <span className="flex items-center gap-1.5">
            <FileText className="w-3 h-3 text-accent-cyan/70" />
            Ln 26, Col 1
          </span>
          <span className="hidden xs:inline">UTF-8 Document</span>
        </div>
